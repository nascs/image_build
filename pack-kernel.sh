...
KERNEL_DIR=$ROCKCHIP_BSP_DIR/linux
...
mv $ROCKCHIP_BSP_DIR/linux-*${RELEASE_NUMBER}-qualcomm*.deb $PACKAGES_DIR
mv $ROCKCHIP_BSP_DIR/linux-*${RELEASE_NUMBER}-qualcomm*.changes $PACKAGES_DIR
